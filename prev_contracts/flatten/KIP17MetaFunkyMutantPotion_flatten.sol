...
/** 
 *  SourceUnit: contracts\KIP17MetaFunkyMutantPotion.sol
*/
...
contract KIP17MetaFunkyMutantPotion is KIP17, KIP17Enumerable, KIP17Metadata, MinterRole, KIP17Burnable {
...
contract KIP17MetaFunkyMutantPotionToken is KIP17Full, KIP17MetaFunkyMutantPotion {
    constructor (string memory name, string memory symbol, MBT mbtToken, address mbtReceiver) public KIP17Full(name, symbol) KIP17MetaFunkyMutantPotion(mbtToken, mbtReceiver) {
    }
}